# Spring PetClinic Sample Application Changed [![Build Status](https://github.com/spring-projects/spring-petclinic/actions/workflows/maven-build.yml/badge.svg)](https://github.com/spring-projects/spring-petclinic/actions/workflows/maven-build.yml)
...
```
git clone https://github.com/yepurivamsikrishna/spring-petclinic.git
cd spring-petclinic
./mvnw package
java -jar target/*.jar
```
